        ...
        <Accordion.Panel>
          ...
          <Accordion.Content>
            <p className="mb-2 text-gray-500 dark:text-gray-400">
              React Router is a standard library for routing in React. Its
              purpose is : It enables the navigation among views of various
              components in a React Application, allows changing the browser
              URL, and keeps the UI in sync with the URL. ReactJS Router is
              mainly used for developing Single Page Web Applications. React
              Router is used to define multiple routes in the application. When
              a user types a specific URL into the browser, and if this URL path
        ...
        <Accordion.Panel>
          ...
          <Accordion.Content>
            <p className="mb-2 text-gray-500 dark:text-gray-400">
              ...
              from parent to child components, without having to pass props down
              manually at each level. SO we dont have to use prop drilling in
              our app if we use Context API.To use Context API we need to use{" "}
              <span className="text-orange-500">CreateContext()</span> and to
              use that context We Just need to{" "}
              <span className="text-orange-500">UseContext()</span>.
            </p>
          </Accordion.Content>
        </Accordion.Panel>
        <Accordion.Panel>
          <Accordion.Title>What is React useRef HOOK?</Accordion.Title>
          <Accordion.Content>
            <p className="mb-2 text-gray-500 dark:text-gray-400">
              ...
              which we can use to access it programmatically. we can also use it
              to keep a reference to the previous state of a component. The
              useRef is a hook that allows to directly create a reference to the
              DOM element in the functional component. the useRef hook returns a
